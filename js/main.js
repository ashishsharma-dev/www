...
let lightLogo = document.querySelector(".navbar-brand img");
let darkLogo = document.querySelector(".navbar-brand img");

let lightLogoUrl =
  "https://wicked-gourmet.in/cdn/shop/files/WickNormal2_x35.png?v=1628150843";
let darkLogoUrl =
  "https://wicked-gourmet.in/cdn/shop/files/wickedlogo_1_x35.png?v=1630387151";

let topNavbar = document.querySelector(".navbar-fixed-top");

let dropdownOptions = document.querySelectorAll(".page-scroll");
